...
class ctrPago extends Controller
{
    public function listar(Request $request){
        ...
        if($buscar==''){
            ...
            ->select('pago.id','pago.fecha as fechaPago','pago.monto as montoPago','cliente.nombre','cliente.apellidos'
                    ,'cliente.razonSocial','propiedad.codigo','propiedad.tipo as tipoPropieadad','planCredito.montoTotal as totalPagar')
