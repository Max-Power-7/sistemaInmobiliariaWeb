                                        ...
                                        <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <template v-if="usuario.estado">
                                                        <a class="dropdown-item bg-light" href="#" @click="abrirModal('usuario','modificar',usuario)"><i class="icon-pencil text-warning"></i>Modificar</a>
                                                        <a class="dropdown-item bg-light" href="#" @click="desactivarUsuario(usuario.id)"><i class="fa fa-toggle-on text-success"></i>Desactivar</a>    
                                                    </template>
                                                    <template v-else>
                                                        <a class="dropdown-item bg-light" href="#" @click="activarUsuario(usuario.id)"><i class="fa fa-toggle-off text-danger"></i>Activar</a>
                                                    </template>
                                                </div>
                                        </div>
                                    </td>
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="login" class="form-control" placeholder="Ingrese un nombre de Usuario">
                                    </div>
                                </div>
                                <div class="form-group row">
