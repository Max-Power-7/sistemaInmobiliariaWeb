<template>
  <main class="main">
              ...
              <tbody>
                <tr v-for="notaventa in arrayNotaVenta" :key="notaventa.id">
                  ...
                  <template v-if="notaventa.tipoCliente == 'persona'">
                    ...
                    <td> {{notaventa.nombreClie}} {{notaventa.apellidos}} </td>
                  </template>
                    ...
                    <div class="dropdown">
                      ...
                      >
                        <a class="dropdown-item bg-light" href="#"
                          ><i class="icon-pencil text-warning"></i>Contrato</a
                        >
                      </div>
                    </div>
                  </td>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-inline">
                        ...
                        <button
                          ...
                          class="btn btn-info"
                        >
                          <i class="fa fa-window-maximize"> Cliente</i>
                        </button>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="collapse" id="collapseExample">
                        <div class="card card-body">
                          ...
                          >
                            <div
                              class="col-md-2.5"
                              v-for="propiedad in arrayPropiedad"
                              :key="propiedad.id"
                            >
                              <div
                                class="card"
                                v-if="propiedad.estado == 'disponible'"
                              >
                                <img
                                  :src="'img/photo2.png'"
                                  @click="sliderImagen(propiedad.id)"
                                  data-toggle="modal"
                                ...
                                <div class="card-body">
                                  <center>
                                    ...
                                    <center>
                                      ...
                                      >
                                        <i size="5" class="fa fa-eye"></i>Ver
                                      </button>
                                    </center>
                                    <font size="3" face="Times New Roman"
                                      ><b>Tipo: </b>{{ propiedad.tipo }}</font
                                    ><br />
                                    <font size="3" face="Times New Roman"
                                      ><b>Precio: </b
                                      >{{ propiedad.precio }} Bs</font
                                    ><br />
                                  </center>
                                </div>
                                <div class="card-footer">
                                  <button
                                    type="button"
                                    @click="agregarPropiedad(propiedad)"
                                    class="btn btn-primary btn-sm"
                                  >
                                    Agregar <i class="fa fa-check"></i>
                                  </button>
                                  <template
                                    v-if="propiedad.estado == 'Mantenimiento'"
                                  >
                                    <button
                                      type="button"
                                      @click="habilitarPropiedad(propiedad.id)"
                                      class="btn btn-primary btn-sm"
                                    >
                                      <i class="fa fa-lock"></i> Habilitar
                                    </button>
                                  </template>
                                </div>
                              </div>
              ...
              <div class="col-md-6">
                <div class="input-group">
                  ...
                  <input
                    ...
                    @keyup.enter="listarCliente(criterioCliente, buscarCliente)"
                    class="form-control"
                    placeholder="Texto a buscar"
                  />
                  <button
                    type="submit"
                    @click="listarCliente(criterioCliente, buscarCliente)"
                    class="btn btn-primary"
                  >
                    <i class="fa fa-search"></i> Buscar
                  </button>
    ...
    <div
      ...
      id="modalNuevo"
      tabindex="-1"
      :class="{ mostrar: modalNuevoCliente }"
      role="dialog"
      aria-labelledby="myModalLabel"
      style="display: none"
      aria-hidden="true"
    ...
    <div
      ...
      id="modalNuevo"
      tabindex="-1"
      :class="{ mostrar: modalVerPropiedad }"
      role="dialog"
      aria-labelledby="myModalLabel"
      style="display: none"
      aria-hidden="true"
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            >
              ...
              <div class="form-group row">
                <label class="col-md-3 form-control-label" for="text-input"
                  >Fecha Inicio de Construccion:</label
                >
                <div class="col-md-9">
              ...
              <div class="form-group row">
                <label class="col-md-3 form-control-label" for="text-input"
                  >fecha Fin de Construccion:</label
                >
                <div class="col-md-9">
          ...
          >
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img
                  :src="'img/propiedad/' + slideImagen[0]"
                  class="d-block w-100"
                  alt="..."
                />
              </div>
              <div class="carousel-item">
                <img
                  :src="'img/propiedad/' + slideImagen[1]"
                  class="d-block w-100"
                  alt="..."
                />
              </div>
...
export default {
  ...
  methods: {
    ...
    listarCliente() {
      let me = this;
      var url =
        "/cliente/listado?criterio=" +
        this.criterioCliente +
        "&buscar=" +
        this.buscarCliente;
      axios
        .get(url)
